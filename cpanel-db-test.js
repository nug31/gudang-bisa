...
console.log('Testing cPanel database connection with the following settings:');
...
connection.connect(function(err) {
  if (err) {
    ...
    if (err.code === 'ER_ACCESS_DENIED_ERROR') {
      ...
      console.error('2. Make sure your IP address is whitelisted in cPanel:');
      console.error('   - Log in to cPanel');
      console.error('   - Go to MySQL Databases > Remote MySQL');
      console.error('   - Add your current IP address (shown in the error message)');
      console.error('3. Check if the user has the necessary permissions');
      ...
      console.error('3. Make sure your IP address is whitelisted');
    }

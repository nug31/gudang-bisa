...
async function testRequestFunctionality() {
  try {
    ...
    // Based on the schema check, we need to use category_id, not category
    const testRequest = {
      id: requestId,
      title: "Test Request " + new Date().toISOString(),
      description: "This is a test request to verify database connectivity",
      category_id: "11111111-1111-1111-1111-111111111111", // Using the UUID from supabase-schema.sql (Office category)
      priority: "medium",
      status: "pending",
      user_id: "55555555-5555-5555-5555-555555555555", // Using the UUID from supabase-schema.sql (Admin User)
      quantity: 1,
      // No inventory_item_id field as it doesn't exist in the schema
    };
